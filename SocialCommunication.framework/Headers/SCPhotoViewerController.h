...
/** Shows the default content menu using SCPopupMenu.
 ...
 Default Implementation:
    ...
    if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        [cv addChoiceWithName:NSLocalizedString(@"Copy", @"MenuItem") andSubTitle:NSLocalizedString(@"Copy to Clipboard", @"Button") andIcon:[UIImage imageNamed:@"ico_copy.png"] andCompletion:^{
            [self copyImage:nil];
        }];
    }
