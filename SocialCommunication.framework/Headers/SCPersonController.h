...
/** Shows the Content Action PopupMenu.
 ...
 Default Implementation:
    ...
    [cv addChoiceWithName:NSLocalizedString(@"Save Contact", @"MenuItem") andSubTitle:NSLocalizedString(@"Save to Contacts", @"Button") andIcon:[UIImage imageNamed:@"ico_save_in_contacts.png"] andCompletion:^{
    ...
    [cv addChoiceWithName:NSLocalizedString(@"Forward", @"MenuItem") andSubTitle:NSLocalizedString(@"Forward to another user", @"Button") andIcon:[UIImage imageNamed:@"ico_forward.png"] andCompletion:^{
        [self forwardContact];
    }];
