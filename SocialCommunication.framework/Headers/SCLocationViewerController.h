...
/** Shows the default content menu using SCPopupMenu.
 ...
 Default Implementation:
    ...
    if (self.currentLocation && self.location) {
        [cv addChoiceWithName:NSLocalizedString(@"Show Route", @"Choice Title") andSubTitle:NSLocalizedString(@"Show Route Information in Google Maps", @"Button") andIcon:[UIImage imageNamed:@"ico_navigate.png"] andCompletion:^{
        ...
        if ([[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"navigon://"]]) {
            [cv addChoiceWithName:NSLocalizedString(@"Navigon Mobile Navigator", @"Choice Title") andSubTitle:NSLocalizedString(@"Launch Navigon", @"Button") andIcon:[UIImage imageNamed:@"ico_launch_navigon.png"] andCompletion:^{
        ...
        if ([[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"tomtomhome://"]]) {
            [cv addChoiceWithName:NSLocalizedString(@"TomTom Navigation", @"Choice Title") andSubTitle:NSLocalizedString(@"Launch TomTom", @"Button") andIcon:[UIImage imageNamed:@"ico_launch_tomtom.png"] andCompletion:^{
        ...
        if ([[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"com.sygic.aura://"]]) {
            [cv addChoiceWithName:NSLocalizedString(@"Sygic GPS", @"Choice Title") andSubTitle:NSLocalizedString(@"Launch Sygic GPS", @"Button") andIcon:[UIImage imageNamed:@"ico_navigate.png"] andCompletion:^{
    ...
    if (url) {
        [cv addChoiceWithName:NSLocalizedString(@"Open Url", @"Choice Title") andSubTitle:NSLocalizedString(@"Open places details", @"Button") andIcon:[UIImage imageNamed:@"ico_open_url.png"] andCompletion:^{
