...
/** Presents a standard C2Call SDK Popup Menu.
 ...
 Example Code:
    ...
    [cv addChoiceWithName:NSLocalizedString(@"Forward", @"MenuItem") andSubTitle:NSLocalizedString(@"Forward to another FriendCaller user", @"Button") andIcon:[UIImage imageNamed:@"ico_forward.png"] andCompletion:^{
